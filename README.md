...
-	Вы получили ссылку-приглашение от преподавателя в GitHub Classroom
...
## 🛠️ Начало работы
```bash
# 1. Перейдите по ссылке-приглашению, которую отправил преподаватель

# 2. Нажмите "Accept this assignment"

# 3. Дождитесь создания вашего личного репозитория (это займет несколько секунд)
# Результат: У вас появится ваш собственный репозиторий по адресу:
# https://github.com/university-media-2025/lab1-http-clients-ваш-логин

# 4. Клонируйте свой репозиторий по SSH
# Скопируйте SSH-ссылку из вашего репозитория (кнопка "Code" → SSH)
git clone git@github.com:university-media-2025/lab1-http-clients-ваш-логин.git

# 5. Перейдите в папку проекта
cd lab1-http-clients-ваш-логин

# 6. Проверьте текущие remote (должен быть только origin)
git remote -v

# 7. Создайте и перейдите в свою ветку
...
# 8. Создайте виртуальное окружение
python -m venv venv

# 9. Активизируйте виртуальное окружения
# Windows:
...
# 11. Обновите менеджер pip
python -m pip install --upgrade pip

# 12. Установите пакет types-requests
...
```
Все изменения делайте в ваше ветке `student-yourname`
## 📊 Источники новостей
...
# 1. Добавьте изменения в отслеживание
git add .

# 2. Сделайте коммит
git commit -m "Выполнение лабораторной работы #1"

# 3. Запушить вашу ветку (student-yourname) в свой личный репозиторий (origin)
git push origin student-yourname

# 4. Создайте Pull Request для поверки
...
# !!! Не мержите Pull Request самостоятельно
# !!! Не удаляйте ветку после создания PR
# !!! Ожидайте проверки и комментариев от преподавателя в созданном Pull Request
# !!! Все дальнейшие исправления делайте в той же ветке и пушите изменения - они автоматически добавятся в Pull Request
```
